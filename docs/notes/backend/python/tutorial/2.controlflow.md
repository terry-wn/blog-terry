...
```python
users = {'Hans': 'active', 'hello': 'inactive', 'Terry': 'active'}
...
<Replit link="https://replit.com/@Terry/python-tutorial#2.2/for.py" />
...
<Replit link="https://replit.com/@Terry/python-tutorial#2.4/else.py" />
...
```shell
python 2.6/match-http-error.py 400
```

<Replit link="https://replit.com/@Terry/python-tutorial#2.6/match-http-error.py" />
...
```shell
python 2.6/match-point.py
```

<Replit link="https://replit.com/@Terry/python-tutorial#2.6/match-point.py" />
