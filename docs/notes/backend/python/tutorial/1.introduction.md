...
```shell
python 1.1/str-demo.py
```

<Replit link="https://replit.com/@Terry/python-tutorial#1.1/str-demo.py" />
...
```shell
python 1.1/list-demo.py
```

<Replit link="https://replit.com/@Terry/python-tutorial#1.1/list-demo.py" />
...
```shell
python 1.2/fibonacci.py
```

<Replit link="https://replit.com/@Terry/python-tutorial#1.2/fibonacci.py" />
